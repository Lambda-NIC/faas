...
docker cp buildoutput:/go/src/github.com/Lambda-NIC/faas/watchdog/watchdog ./fwatchdog
docker cp buildoutput:/go/src/github.com/Lambda-NIC/faas/watchdog/watchdog-armhf ./fwatchdog-armhf
docker cp buildoutput:/go/src/github.com/Lambda-NIC/faas/watchdog/watchdog-arm64 ./fwatchdog-arm64
docker cp buildoutput:/go/src/github.com/Lambda-NIC/faas/watchdog/watchdog.exe ./fwatchdog.exe
