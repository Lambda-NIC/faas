...
* [Docker Swarm](https://github.com/Lambda-NIC/faas/blob/master/guide/deployment_swarm.md)
* [Kubernetes](https://github.com/Lambda-NIC/faas/blob/master/guide/deployment_k8s.md)
