...
* [Read a tutorial on the FaaS CLI](https://github.com/Lambda-NIC/faas-cli)
...
- [x] Add the fwatchdog binary from the [Releases page](https://github.com/Lambda-NIC/faas/releases) via `curl` or `ADD https://`
