...
The Function Store is rendered through a static JSON file served by the GitHub RAW CDN. The Function Store can also be used via the [OpenFaaS CLI](https://github.com/Lambda-NIC/faas-cli).
...
| `functions_provider_url`             | URL of upstream [functions provider](https://github.com/Lambda-NIC/faas-provider/) - i.e. Swarm, Kubernetes, Nomad etc  |
